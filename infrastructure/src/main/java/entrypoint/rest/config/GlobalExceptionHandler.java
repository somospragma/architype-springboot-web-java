package entrypoint.rest.config;
...
import static constants.ExceptionsConstants.EMPTY_MESSAGE_INTERNAL_ERROR;
import static constants.ExceptionsConstants.INTERNAL_SERVER_ERROR;
import static constants.ExceptionsConstants.LAYER_CROSSCUTTING_GLOBAL_EXCEPTION_HANDLER_GET_TRANSACTION_ID;
import static constants.ExceptionsConstants.LAYER_CROSSCUTTING_GLOBAL_EXCEPTION_HANDLER_RESOLVE_MESSAGE;
import static constants.ExceptionsConstants.MESSAGE_KEY_NOT_AVAILABLE_TRANSACTION_ID_ERROR;
import static constants.ExceptionsConstants.MESSAGE_KEY_NOT_FOUND_ERROR;
import static constants.ExceptionsConstants.MISSING_HEADER_EXCEPTION;
import static constants.ExceptionsConstants.MISSING_PARAMETER_EXCEPTION;
import static constants.ExceptionsConstants.NOT_AVAILABLE_TRANSACTION_ID_ERROR;
import static constants.ExceptionsConstants.NOT_FOUND_ERROR;
import static constants.ExceptionsConstants.NO_RESOURCE_FOUND_EXCEPTION;
import static constants.ExceptionsConstants.UTILITY_500_ERROR;
import static constants.ExceptionsConstants.UTILITY_EXCEPTION_MESSAGE;
import static constants.ExceptionsConstants.UTILITY_EXCEPTION_TYPE;
